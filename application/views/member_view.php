          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<?php echo base_url('index.php/member')?>">Member<span class="sr-only">(current)</span></a></li>
              </ul>
            </div>
          </div>
    </nav>
...
function edit_member(member_id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('member/ajax_edit')?>/" + member_id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('member/ajax_add')?>";
    } else {
        url = "<?php echo site_url('member/ajax_update')?>";
    }
...
function delete_member(member_id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('member/ajax_delete')?>/"+member_id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="member_phone" placeholder="Phone" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
